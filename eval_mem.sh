...
# I/O
out_dir=./out/retry2_repeat_custom4096_len256_memory32_ffn_norm_reusekv_trainmem
# out_dir=./out/retry_repeat_custom4096_len256_memory32_ffn_norm_reusekv_trainmem
